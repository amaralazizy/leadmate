  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
      {features.map((feature, index) => (
        <div
          key={index}
          className="rounded-2xl border-2 p-6 hover:-translate-x-1 hover:-translate-y-1 transition-all bg-dark-card border-main shadow-[6px_6px_0px_0px_rgba(57,255,20,0.8)] hover:shadow-[8px_8px_0px_0px_rgba(57,255,20,1)]"
        >
