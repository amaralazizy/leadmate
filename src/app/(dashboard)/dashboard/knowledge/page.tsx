  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold">WhatsApp Bot Dashboard</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-gray-500">WhatsApp number verified</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-gray-500">+12% vs yesterday</p>
          </CardContent>
        </Card>
      ...
      <Tabs defaultValue="chatbot">
        <TabsList>
          <TabsTrigger value="chatbot">
            <Bot className="w-4 h-4 mr-1" /> Chatbot
          </TabsTrigger>
        ...
        <TabsContent value="chatbot">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              />
              <Textarea placeholder="FAQ Responses / Flow Config" />
        ...
        <TabsContent value="conversations">
          <Card>
            <CardHeader>
              <CardTitle>Live Inbox</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-gray-500">
                Incoming and outgoing chats will appear here.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="analytics">
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-gray-500">
                Charts & stats integration here (Recharts).
              </p>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="settings">
          <Card>
            ...
            <CardContent className="space-y-4">
              <Input placeholder="Business Name" defaultValue="My Shop" />
              <Input placeholder="Business Category" defaultValue="Retail" />
